...
- [ ] WELayoutUtility refactored to accept IECSReader as constructor parameter or static injection field
- [ ] All callers updated to pass new EntityManagerECSReader(...)
- [ ] WELayoutUtilityTests.cs added with >=8 tests using NSubstitute mock of IECSReader
