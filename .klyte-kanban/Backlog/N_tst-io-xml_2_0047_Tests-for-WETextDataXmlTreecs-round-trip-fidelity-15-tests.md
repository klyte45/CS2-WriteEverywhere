...
- [ ] Tests cover: ToXML()->FromXML() produces equal object (deep comparison), serialized XML contains <WELayout>, <self> and <children> structure, FromXML(null) returns null, FromXML("") returns null, children empty by default, ShouldSerializechildren() behavior, Guid non-empty, WETemplateVariable key/value survives serialization
