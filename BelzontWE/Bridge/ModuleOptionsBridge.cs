...
namespace BelzontWE.Bridge
{
    ...
    public static class ModuleOptionsBridge
    {
        ...
        public static void ForceReloadOptions()
        {
            instance ??= World.DefaultGameObjectInjectionWorld.GetOrCreateSystemManaged<WEModulesSystem>();
            instance.ForceReloadOptions();
        }
        ...
        public static (int, object) AsButtonRowOptionData(Action<string> handler, Func<Dictionary<string, string>> optionsLister_value_displayNameI18n) => (3, new WEModuleOptionField_ButtonRow.Options(handler, optionsLister_value_displayNameI18n));
