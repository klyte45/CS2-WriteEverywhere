        ...
        <Panel draggable header={T_title} className="k45_we_floatingSettingsPanel k45_contentFillPanel" initialPosition={defaultPosition} style={{ height: "450rem", display: "flex", flexDirection: "column" }}
            ...
            {![WESimulationTextType.GameProp, WESimulationTextType.Placeholder].includes(wps.mesh.TextSourceType.value) ? <>
                ...
                <FormulaeEditRow formulaeModule="transform" formulaeField="ArrayInstancingGapMeters" label={T_arrayDistanceCm} defaultInputField={<FocusDisabled>
                    <FloatInputStandalone style={{ flexGrow: 1, flexShrink: 1 }} className={editorModule.input} value={wps.transform.ArrayInstancingGapMeters.value[0]} onChange={(x) => wps.transform.ArrayInstancingGapMeters.set([x, wps.transform.ArrayInstancingGapMeters.value[1], wps.transform.ArrayInstancingGapMeters.value[2]])} />
                    <FloatInputStandalone style={{ flexGrow: 1, flexShrink: 1 }} className={editorModule.input} value={wps.transform.ArrayInstancingGapMeters.value[1]} onChange={(x) => wps.transform.ArrayInstancingGapMeters.set([wps.transform.ArrayInstancingGapMeters.value[0], x, wps.transform.ArrayInstancingGapMeters.value[2]])} />
                    <FloatInputStandalone style={{ flexGrow: 1, flexShrink: 1 }} className={editorModule.input} value={wps.transform.ArrayInstancingGapMeters.value[2]} onChange={(x) => wps.transform.ArrayInstancingGapMeters.set([wps.transform.ArrayInstancingGapMeters.value[0], wps.transform.ArrayInstancingGapMeters.value[1], x])} />
                </FocusDisabled>}
                />
