...
const WETextDataMeshController = {
    ...
    CustomMeshNameFormulaeStr: MultiUIValueBinding<string>,
    CustomMeshNameFormulaeCompileResult: MultiUIValueBinding<number>,
    CustomMeshNameFormulaeCompileResultErrorArgs: MultiUIValueBinding<string[]>,
...
const WETextDataMaterialController = {
    ...
    UseGlobalLight: MultiUIValueBinding<boolean>,
}
